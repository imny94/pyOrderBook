...
class TransactionMatcher():
    ...
    def __init__(self, askTree, bidTree, eventList, database, terminateFlag, verbose):
        ...
        self.database.NewTable("transactions")
    ...
    def runMatches(self):
        ...
        while 1:
            ...
            while askOrders and bidOrders:
                ...
                self.database.InsertData("transactions",newTransaction)
